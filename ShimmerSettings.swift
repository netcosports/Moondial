...
protocol ShimmersContainer {
  var shimmers: [ShimmerSettings] { get }
}

class ShimmerSettings: Shimmerable {
  ...
  func width(_ value: CGFloat) -> ShimmerSettings {
    self.width = value
    return self
  }

  func height(_ value: CGFloat) -> ShimmerSettings {
    self.height = value
    return self
  }

  func cornerRadius(_ value: CGFloat) -> ShimmerSettings {
    self.cornerRadius = value
    return self
  }

  func customShape(_ value: @escaping (CGRect) -> (UIBezierPath)) -> ShimmerSettings {
    self.customShape = value
    return self
  }

  func vAlignment(_ value: ShimmerAlignment) -> ShimmerSettings {
    self.vAlignment = value
    return self
  }

  func hAlignment(_ value: ShimmerAlignment) -> ShimmerSettings {
